...
func (pu *PositionUpdate) SetNameposition(s string) *PositionUpdate {
	pu.mutation.SetNameposition(s)
	return pu
}
...
func (pu *PositionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Nameposition(); ok {
...
// SetNameposition sets the Nameposition field.
func (puo *PositionUpdateOne) SetNameposition(s string) *PositionUpdateOne {
	puo.mutation.SetNameposition(s)
	return puo
}
...
func (puo *PositionUpdateOne) sqlSave(ctx context.Context) (po *Position, err error) {
	...
	if value, ok := puo.mutation.Nameposition(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: position.FieldNameposition,
