...
// The PositionassingmentQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PositionassingmentQueryRuleFunc func(context.Context, *ent.PositionassingmentQuery) error

// EvalQuery return f(ctx, q).
func (f PositionassingmentQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PositionassingmentQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PositionassingmentQuery", q)
}

// The PositionassingmentMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PositionassingmentMutationRuleFunc func(context.Context, *ent.PositionassingmentMutation) error

// EvalMutation calls f(ctx, m).
func (f PositionassingmentMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PositionassingmentMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PositionassingmentMutation", m)
}
